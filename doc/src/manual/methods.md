...
Just as you can put subtype constraints on type parameters in type declarations (see [Parametric Types](@ref man-types-parametric)),
...
## [Note on Optional and keyword Arguments](@id man-methods-optional-keyword)
